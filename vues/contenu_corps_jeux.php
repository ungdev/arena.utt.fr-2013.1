		<div class="container">
			...
			<p>Suivez le guide ! Les jeux indiqués en xxx sont gratuits. </p>

			<img src="http://upload.wikimedia.org/wikipedia/fr/thumb/7/77/League_of_Legends_logo.png/280px-League_of_Legends_logo.png">
			LEAGUE OF LEGENDS [GRATUIT] 
			...
			<a href="https://signup.leagueoflegends.com/fr/signup/index">A télécharger ici. </a> 

			</br>  

			<img src="http://upload.wikimedia.org/wikipedia/en/thumb/0/08/DotA2.jpg/250px-DotA2.jpg">
			DOTA 2 [GRATUIT]
			Dota 2 est un jeu vidéo d'arène de bataille en ligne multijoueur développé et édité par Valve Corporation. Le jeu fait suite à Defense of the Ancients, un mod de carte personnalisée pour le jeu de stratégie en temps réel Warcraft III: Reign of Chaos et son extension Warcraft III: The Frozen Throne.
			<a href="http://store.steampowered.com/app/570/">A télécharger ici. </a>
			</br> 

			<img src="http://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/StarCraft2logo.png/250px-StarCraft2logo.png">
			STARCRAFT 2 [PAYANT]
			StarCraft II: Wings of Liberty est la suite très attendue du premier StarCraft, le légendaire jeu de stratégie en temps réel créé par Blizzard Entertainment. StarCraft II: Wings of Liberty est à la fois un jeu solo prenant et un jeu multijoueur rapide. Il s’appuie pour cela sur Battle.net, le service de jeu en ligne très complet de Blizzard Entertainment. 

			<a href="http://eu.battle.net/sc2/fr/buy-now/">A télécharger ici. </a>
			</br>

			<img src="http://upload.wikimedia.org/wikipedia/fr/thumb/5/59/Age_of_Empires_II_The_Age_of_Kings_Logo.png/230px-Age_of_Empires_II_The_Age_of_Kings_Logo.png">
			AGE OF EMPIRES 2 [OLDIES]
			...
			<img src="http://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Counter-Strike_Global_Offensive.svg/280px-Counter-Strike_Global_Offensive.svg.png">
			COUNTER STRIKE: GLOBAL OFFENSIVE [PAYANT]
			...
			CALL OF DUTY 4 : MODERN WARFARE [PAYANT]
			...
			<a href="http://www.callofduty.com/fr">A télécharger ici. </a>
			</br>
			...
			<img src="http://upload.wikimedia.org/wikipedia/fr/thumb/d/db/UnrealTournamentLogo.jpg/230px-UnrealTournamentLogo.jpg">
			UNREAL TOURNAMENT 99 [OLDIES] 
			...
			<img src="http://cdn3.steampowered.com/v/gfx/apps/440/header_292x136.jpg?t=1376664686">
			TEAM FORTRESS 2 [GRATUIT]
			...
			<img src="http://cdn3.steampowered.com/v/gfx/apps/550/header_292x136.jpg?t=1376076312">
			LEFT 4 DEAD 2 [PAYANT]
			Situé dans un univers post-apocalyptique peuplé de zombies, Left 4 Dead 2 (L4D2) est la suite très attendue du titre élu meilleur jeu de coopération 2008. 
			...
			<a href="http://store.steampowered.com/app/550/?snr=1_7_15__13">A télécharger ici. </a>
			</br>

			<img src="http://cdn3.steampowered.com/v/gfx/apps/201790/header_292x136.jpg?t=1373994462">
			ORCS MUST DIE 2 [PAYANT]
			Vous les avez envoyés valdinguer, vous les avez brûlés et découpés par milliers… mais les orques sont de retour et l’heure du massacre a de nouveau sonné ! Embrigadez un ami et tuez des orques à tour de bras dans cette suite du fameux jeu de Robot Entertainment, élu « Meilleur jeu de stratégie 2011 » par AIAS. 

			Incarnez un puissant mage de guerre ou une redoutable sorcière et plongez au cœur du combat pour défendre de nouvelles forteresses et les mines des nains. Comment ? En réduisant des milliers d’orques et de monstres en chair à pâté à l’aide d’un impressionnant arsenal d’armes, de sorts, de gardes, de pièges et autres babioles en tout genre. Jouez en coop avec un ami et menez le combat dans un mode campagne inédit, ou battez-vous pour sauver votre peau dans le tout nouveau, mais non moins difficile, mode Sans fin ! 
			<a href="http://store.steampowered.com/app/201790/?snr=1_7_15__13">A télécharger ici. </a>
			</br>

			<img src="http://cdn3.steampowered.com/v/gfx/apps/65800/header_292x136.jpg?t=1376075374">
			DUNGEON DEFENDERS [PAYANT]
			Dungeon Defenders est un jeu de rôle et d’action de tourelles défensives dans lequel vous devez défendre le royaume d’Etheria ! Créez un héros et combattez les vagues d’ennemis en organisant la défense et en participant directement au combat. 
			...
			<a href="http://store.steampowered.com/app/65800/?snr=1_7_15__13">A télécharger ici. </a>
			</br>

			<img src="http://cdn3.steampowered.com/v/gfx/apps/96400/header_292x136.jpg?t=1333731441">
			SHOOT MANY ROBOTS [PAYANT]
			Jouable à quatre, ce jeu de tir bourré d'action de type run-n-gun vous confronte à un déluge de robots dégénérés, avec un arsenal qui fera saliver tout bon amateur de tir.

			Les joueurs prennent le contrôle de P. Walter Tugnut (P pour « Pickles »), un bon gros bouseux du sud des États-Unis qui stocke des flingues, des munitions et de la bière dans son camping-car pouilleux en attendant l'inévitable apocalypse robotique. Quand l'usine abandonnée, au loin, commence à produire des robots sans motif apparent, Walter part pour une virée roboticide à bord de son camping-car, dans l'espoir de sauver l'humanité face à l'armada métallique.
			<a href="http://store.steampowered.com/app/96400/?snr=1_7_15__13">A télécharger ici. </a>
			</br>

			<img src="http://cdn3.steampowered.com/v/gfx/apps/1250/header_292x136.jpg?t=1376583406">
			KILLING FLOOR [PAYANT]
			Killing Floor est un jeu de tir subjectif d'horreur, de survie et de coopération qui se déroule en Angleterre à la campagne après qu'une expérience militaire de clonage se soit mal déroulée. Vous êtes parachuté au cœur du problème et devez le résoudre en nettoyant la zone. 
			<a href="http://store.steampowered.com/app/1250/">A télécharger ici. </a>
			</br>

			<img src="http://cdn3.steampowered.com/v/gfx/apps/400/header_292x136.jpg?t=1374685745">
			PORTAL [PAYANT]
			...
			<a href="http://store.steampowered.com/app/400/">A télécharger ici. </a>
			</br>
